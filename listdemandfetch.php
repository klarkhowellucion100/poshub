    ...
    <div class="card">
        ...
        <table id="table_collect2" class="table table-striped table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
             ...
             <tbody>
                 <?php
                     include 'db.inc.php';
                     $query001 = mysqli_query($conn,"SELECT trans_partner, trans_comm, trans_commitvol, trans_volume, trans_volume-trans_commitvol AS diff  FROM erp_record WHERE trans_partnertype='Vendor' AND (trans_adate BETWEEN '$datefrom' AND '$dateto')");
