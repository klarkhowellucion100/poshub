                    ...
                    <div class="row">          
                         ...
                         ?> 
                                 <div class="mb-3" >
                                     ...
                                     <input type="text" class="form-control" required id="trans_price" value="<?php echo $q1['comm_fgp_f'];?>">     
                                 </div>
                         <?php } ?>    
                         ...
                         ?> 
                                 ...
                                 <div class="mb-3">
                                     <label for="dund" class="form-label">Received Volume (kg)</label>
                                 ...
                                 <div class="mb-3">
                                     <label for="trans_act_volume" class="form-label">Actual Weighed Volume (kg)</label>
                                     <input type="text" class="form-control" required id="trans_act_volume" value="<?php echo $q['trans_act_volume'];?>" placeholder="Please Enter Weight (kg) *">
                                 </div>
                         <?php } ?>                                    
