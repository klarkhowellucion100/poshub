                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <h5 style="font-size:12px; color:black;">Supply Commitment Summary</h5> <button class="btn btn-primary addproduct" data-bs-toggle="modal" data-bs-target="#myModal01"><i class="uil-plus"></i></button>
                                          ...
                                          <!-- sample modal content -->
                                           <div id="myModal01" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="myModalLabel">Supply</h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <script>
                                                         function updateproduct(){
                                                                ...
                                                                var trans_act_volume= $('#trans_act_volume').val();                                                      
                                                                        ...
                                                                        $.ajax({
                                                                                ...
                                                                                method:"POST",
                                                                                data:{trans_id:trans_id,trans_price:trans_price,trans_volume:trans_volume,trans_act_volume:trans_act_volume},
                                                                                success:function(data,status){
