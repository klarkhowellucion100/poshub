                                        ...
                                        <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" aria-label="Default select example" id="type_main">
                                                                ...
                                                                <option value=''>All</option>
                                                                <option value='Farmgate'>Purchase</option>
                                                                <option value='Wholesale'>Sales</option>
            ...
            <div id="type_purchase">
                <div class="row">
                    ...
                    ?>
                        ...
                        <?php
                        $query1 = mysqli_query($conn,"SELECT * FROM commodityhubpos ORDER BY commodity ASC");
     ...
     function addproduct(){
                            ...
                            function DeleteUser(deleteid){
                                ...
                                if(confirm("Are you sure you want to delete this data?")){
                                    $.ajax({
                                                url:"transactiontransdelete.php",
                                                method:"POST",
                                                    ...
                                                    $('#type_main').change(function(){
                                                        ...
                                                        var commodity_main = $('#commodity_main').val();                                                   
                                                            $.ajax({
                                                                ...
                                                                method:"POST",
                                                                data:{type_main:type_main,commodity_main:commodity_main},
                                                                success:function(data){
            ...
            <div class="card-header bg-transparent border-bottom">
                <h5 class="mb-0">Transaction</h5>
                            ...
                            <div class="p-4">
                                    ...
                                    <form action="transactionsincoming.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4"> <select class="form-select transpartner_1 transpartner_2" name="trans_partner" id="transpartner_1">
                                                        <option value="">Please Select Name</option>
                                                            <?php  
                                                                $sql = "SELECT * FROM registrationhubpos GROUP BY fname";
                                                                $query = mysqli_query($conn, $sql);
                                                            ?>
                                                             <?php foreach($query as $q){ ?>  
                                                    ...
                                                    <script>
                                                        ...
                                                        $('.transpartner_1').change(function(){
                                                            ...
                                                            var transpartner_1 = $('.transpartner_1').val();                                                    
                                                                $.ajax({
                                                                    url:"transactionfetchpartner.php",
                                                                    method:"POST",
