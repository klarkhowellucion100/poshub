                                    ...
                                    <div class="mt-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4">
                                                        <div class="mb-3">
                                                            <div class="commo">
                                                                <label for="enat">Collector</label>
                                                                <select class="form-select type_selection_class" aria-label="Default select example" id="commoditydate">  
                                                                <option value="">All</option>                                                                
                                                                    <?php  
                                                                        $sql = "SELECT * FROM com_vol_mon GROUP BY redtp";
                                                                        $query = mysqli_query($conn, $sql);
                                                                    ?>
                                                                    <?php foreach($query as $q){ ?>  
                                                                        <option value="<?php echo $q ['redtp'];?>"><?php echo $q ['redtp'];?></option>
                                                                    <?php } ?>
                                                    ...
                                                    <script>
                                                        ...
                                                        $('#filter001').click(function(){
                                                            ...
                                                            var commoditydate = $('#commoditydate').val();                                              
                                                                $.ajax({
                        ...
                        <div class="col-md-6 col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(pay_subtotal) FROM com_vol_mon WHERE (cyear LIKE '%$yearnow%')");
                        ...
                        <div class="col-md-6 col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                            include 'db.inc.php';
                                            $query = mysqli_query($conn,  "SELECT SUM(vol_subtot) FROM com_vol_mon WHERE (cyear LIKE '%$yearnow%')");
                                            while($result = mysqli_fetch_array($query)): ?>
                                                <?php                                                            
                            ...
                            <div class="card">
                                ...
                                <table id="table_collect" class="table table-striped table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                     ...
                                     <tbody>
                                         <?php
                                             include 'db.inc.php';
                                             $query001 = mysqli_query($conn,"SELECT redtp, SUM(pay_subtotal), SUM(vol_subtot) FROM com_vol_mon WHERE (cyear LIKE '%$yearnow%') GROUP BY redtp");
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php
                                                include 'db.inc.php';
                                                $query1 = mysqli_query($conn,"SELECT * FROM drvolume GROUP BY recno ORDER BY ndtdr DESC");
