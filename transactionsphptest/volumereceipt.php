...
<div class="row" >
                        <div class="col-6 mx-auto">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <a class='btn btn-primary' href="volumeadd.php" style="margin-top: 20px;"> Exit </a> 
                                        ...
                                        <div class="table-responsive">
                                            <table class="table-centered table table-wrap mb-0" style="width:100%;">
                                                ...
                                                <tr>
                                                        ...
                                                        <th style="width: 100px;  font-size:12px; font-weight: bold; color:black;">Kg per Unit</th>     
                                                        <th style="width: 100px; font-size:12px; font-weight: bold; color:black;">Rate per Unit</th>       
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 50px;  font-size:11px; color:black;"><?php echo $result2['deuw'];?></td>
                                                        <td style="width: 50px;  font-size:11px; color:black;"><?php echo $result2['drate'];?></td>
