! function(c) {
    ...
    e.prototype.init = function() {
        c(".select2").select2(), c(".select2-limiting").select2({
            maximumSelectionLength: 2
        }), c(".select2-search-disable").select2({
            minimumResultsForSearch: 1 / 0
        }), c("#colorpicker-default").spectrum(), c("#colorpicker-showalpha").spectrum({
            showAlpha: !0
        ...
        c('[data-toggle="touchspin"]').each(function(e, a) {
            ...
            buttondown_class: "btn btn-primary",
            buttonup_class: "btn btn-primary"
        }), c("input[name='demo_vertical']").TouchSpin({
            verticalbuttons: !0
    ...
    }, c.AdvancedForm = new e, c.AdvancedForm.Constructor = e
}(window.jQuery),
function() {
    "use strict";
    ...
    o.on({
    ...
    }).datepicker(d), $(".docs-options, .docs-toggles").on("change", function(e) {
        var a, t = e.target,
            n = $(t),
            c = n.attr("name"),
        ...
        var a, t = $(this).data(),
            n = t.arguments || [];
        e.stopPropagation(), t.method && (t.source ? o.datepicker(t.method, $(t.source).val()) : (a = o.datepicker(t.method, n[0], n[1], n[2])) && t.target && $(t.target).val(a))
    })
