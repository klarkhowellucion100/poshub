                                ...
                                <table id="table_collect" class="table table-striped table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                     ...
                                     <tbody>
                                         ...
                                         <tr>
                                                ...
                                                <td>Partial</td> 
                                               <td> <button onClick="updateme('update=<?php echo $result001 ['trans_code'];?>&&paydate=<?php echo $date_f;?>')" <?php if ($status_final == "Paid") { echo 'disabled'; } ?> class="btn  btn-raised btn-success waves-effect">Paid</button>
                                               <button onClick="updateme('update=<?php echo $result001 ['trans_code'];?>&&paydate=<?php echo $date_f;?>')" <?php if ($status_final == "Paid") { echo 'disabled'; } ?> class="btn  btn-raised btn-warning waves-effect">Partial</button></td>
