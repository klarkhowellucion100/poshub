                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to the AgriHub POS System</p>
                            </div>
                            <div class="p-2 mt-4">
                                <form method="post" action="loginprocess.php">
                                    ...
                                    <div class="mt-3 text-end">
                                        <input type="submit" name="signin" value="Sign In"  class="btn btn-primary w-sm waves-effect waves-light">
                                    </div>
                    ...
                    <div class="mt-5 text-center">
                        <p>©
                            ...
                            </script> AgriHub. Crafted with <i class="mdi mdi-heart text-danger"></i> by KlarkSite</p>
                    </div>
