...
if(isset($_POST['trans_id']) && isset($_POST['trans_price']) && isset($_POST['trans_volume']) && isset($_POST['trans_act_volume'])){
        ...
        $trans_act_volume= mysqli_real_escape_string($conn,$_POST['trans_act_volume']);

        $query = "UPDATE transactionfinalhubpos SET trans_id= '".$trans_id."',                
        trans_price= '".$trans_price."',
        trans_act_volume= '".$trans_act_volume."',
