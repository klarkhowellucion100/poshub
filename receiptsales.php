                                ...
                                <table id="table_collect2" class="table table-striped table-bordered dt-responsive wrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                     ...
                                     <tbody>
                                         ...
                                         <?php 
                                               ...
                                               <button <?php if ($status_final == "Paid") { echo 'disabled'; } ?> class="btn  btn-raised btn-warning waves-effect productinfo" data-id="<?php echo $result001['trans_code'];?>">Partial</button></td>
